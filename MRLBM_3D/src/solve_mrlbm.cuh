...
inline void copyHaloInterfaces(haloData &dst, const haloData &src)
{
...
inline void copyHaloHostToDevice(haloData &dst, const haloData &src)
{
...
inline void copyHaloDeviceToHost(haloData &dst, const haloData &src)
{
