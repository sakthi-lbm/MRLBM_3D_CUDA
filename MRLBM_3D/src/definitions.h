...
constexpr size_t BLOCK_THREAD_X = 32; // Number of threads in x direction
constexpr size_t BLOCK_THREAD_Y = 4; //// Number of threads in y direction
constexpr size_t BLOCK_THREAD_Z = 2; //// Number of threads in z direction
...
constexpr const size_t BLOCK_FACE_YZ = BLOCK_THREAD_Y * BLOCK_THREAD_Z;
constexpr const size_t BLOCK_GHOST_SIZE = BLOCK_FACE_XY + BLOCK_FACE_XZ + BLOCK_FACE_YZ;

constexpr size_t NUM_LBM_NODES = TOTAL_NUMBER_OF_THREADS;
constexpr const size_t NUM_HALO_FACE_XY = BLOCK_THREAD_X * BLOCK_THREAD_Y * NUMBER_OF_BLOCKS;
constexpr const size_t NUM_HALO_FACE_XZ = BLOCK_THREAD_X * BLOCK_THREAD_Z * NUMBER_OF_BLOCKS;
constexpr const size_t NUM_HALO_FACE_YZ = BLOCK_THREAD_Y * BLOCK_THREAD_Z * NUMBER_OF_BLOCKS;
