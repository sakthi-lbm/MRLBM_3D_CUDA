                                           ...
                                           int iter)
{
    ...
    dMom.uy[idx] = uy;
    dMom.uz[idx] = uz;
    dMom.mxx[idx] = mxx; // Incoming Moment mxxI only for curved boundary nodes
    dMom.myy[idx] = myy; // Incoming Moment myyI only for curved boundary nodes
    dMom.mzz[idx] = mzz; // Incoming Moment mzzI only for curved boundary nodes
    dMom.mxy[idx] = mxy; // Incoming Moment mxyI only for curved boundary nodes
    dMom.mxz[idx] = mxz; // Incoming Moment mxzI only for curved boundary nodes
